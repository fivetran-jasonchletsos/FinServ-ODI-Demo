...
// Three-cluster nav, mirrors Clarity / Verity:
...
const NAV: NavEntry[] = [
  ...
  { kind: 'link', to: '/macro',      label: 'Macro' },
  { kind: 'link', to: '/complaints', label: 'Complaints' },
  { kind: 'link', to: '/geography',  label: 'Geographic' },
  { kind: 'link', to: '/agent',      label: 'Research AI' },
  {
    kind: 'group',
    label: 'dbt-Wizard',
    rootTo: '/dbt-wizard',
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <p className="leading-relaxed text-white/70">
              SEC EDGAR · FRED · CFPB → Fivetran → Iceberg on S3 → dbt labs + dbt-wizard → Great Expectations
              → Snowflake / Athena / Trino → run-time agents → NewCo Activations → Bloomberg AIM
            </p>
